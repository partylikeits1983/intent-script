...
contract DeployIntentRouter is Script {
    function run() external returns (address router) {
        ...
        targets[10] = 0xC36442b4a4522E871399CD717aBDD847Ab11FE88; // Uniswap V3 NonfungiblePositionManager
        targets[11] = 0x889edC2eDab5f40e902b864aD4d7AdE8E412F9B1; // Lido Withdrawal Queue
        targets[12] = 0xBA12222222228d8Ba445958a75a0704d566BF2C8; // Balancer V2 Vault (flashloans)
        targets[13] = 0xBBBBBbbBBb9cC5e90e3b3Af64bdAF62C37EEFFCb; // Morpho Blue
        targets[14] = 0x5c7BCd6E7De5423a257D81B442095A1a6ced35C5; // Across V3 SpokePool
